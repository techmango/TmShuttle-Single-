...
namespace cSouza.WinForms.Controls
{
    ...
    public partial class ShadowLabel : Label
    {
        ...
        public ShadowLabel()
        {
            ...
            this.backcolorBrush = new SolidBrush(this.borderColor);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //SizeF size = e.Graphics.MeasureString(this.Text, this.Font);//获取字符串的大小
            e.Graphics.DrawString(this.Text, this.Font, this.backcolorBrush, 1, 1, StringFormat.GenericTypographic);
            e.Graphics.DrawString(this.Text, this.Font, this.forecolorBrush, 0, 0, StringFormat.GenericTypographic);
